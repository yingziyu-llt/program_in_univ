...
class ImdbNet(Module):
    def __init__(self):
        ...
        self.lstm = torch.nn.RNN(input_size=64, hidden_size=64)
...
for epoch in range(1, n_epoch + 1):
    ...
    writer.add_scalars(
        "raw_RNN/losses", {"train_loss": train_loss, "test_loss": test_loss}, epoch
    )
    writer.add_scalars(
        "raw_RNN/acc", {"train_acc": train_acc, "test_acc": test_acc}, epoch
    )
