...
template < typename ZeroSumGameStateType > class AlphaBetaSearch {
private:
    ...
    static_assert( std::is_base_of< NPlayerGameStateBase< ActionType, 2 >, ZeroSumGameStateType >::value, "ZeroSumGameStateType not derived from NPlayerGameStateBase<ActionType, 2>." );
