...
public:
    ...
    std::vector< int > edge_end() const {
        return _edge_end;
    }
    std::vector< double > weight() const {
        return _weight;
    }
    std::vector< int > first() const {
        return _first;
    }
...
public:
    ...
    int last_edge_index() const {
        return _last_edge_index;
    }
    DirectedGraph graph() const {
        return *_graph;
    }
    ...
    friend bool operator==( const DirectedGraphState& ds1, const DirectedGraphState& ds2 ) {
        ...
        return ( ds1._current_node == ds2._current_node and ds1._target_node == ds2._target_node and ds1._graph == ds2._graph );
    }
};

template <> struct std::hash< DirectedGraphState > {
