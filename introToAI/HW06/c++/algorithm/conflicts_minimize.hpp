...
// 冲突最小化算法，求解约束满足问题
template < typename ConstraintSatisfactionType > class ConflictMinimize {
private:
...
public:
    ...
    void search( int iterations, int max_steps, SelectionBase& selection, ConflictValueEstimatorType value_of = default_conflict_value_estimator ) {
