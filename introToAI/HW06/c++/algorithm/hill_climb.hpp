...
// 爬山算法
template < typename StateLocalType > class HillClimb {
private:
    ...
    const StateLocalType& sample_path( ValueEstimatorType value_of, double target_value, int max_steps, SelectionBase& selection ) {
...
public:
    ...
    void search( ValueEstimatorType value_of, double target_value, int max_steps, SelectionBase& selection, int iterations ) {
